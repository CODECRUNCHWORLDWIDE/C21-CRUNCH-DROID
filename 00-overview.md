...
- [week 01 kotlin 2x jvm language](./curriculum/week-01-kotlin-2x-jvm-language/00-overview.md)
- [week 02 null safety sealed types algebraic core](./curriculum/week-02-null-safety-sealed-types-algebraic-core/00-overview.md)
- [week 03 generics inline functions context receivers](./curriculum/week-03-generics-inline-functions-context-receivers/00-overview.md)
- [week 04 coroutines structured concurrency](./curriculum/week-04-coroutines-structured-concurrency/00-overview.md)
- [week 05 flow stateflow sharedflow channels](./curriculum/week-05-flow-stateflow-sharedflow-channels/00-overview.md)
- [week 06 android runtime art gradle aosp](./curriculum/week-06-android-runtime-art-gradle-aosp/00-overview.md)
- [week 07 jetpack compose composition recomposition](./curriculum/week-07-jetpack-compose-composition-recomposition/00-overview.md)
- [week 08 state side effects snapshots](./curriculum/week-08-state-side-effects-snapshots/00-overview.md)
- [week 09 layout gestures animation accessibility](./curriculum/week-09-layout-gestures-animation-accessibility/00-overview.md)
- [week 10 navigation 3 type safe routes](./curriculum/week-10-navigation-3-type-safe-routes/00-overview.md)
- [week 11 material 3 material you dynamic color](./curriculum/week-11-material-3-material-you-dynamic-color/00-overview.md)
- [week 12 mvvm udf now in android](./curriculum/week-12-mvvm-udf-now-in-android/00-overview.md)
- [week 13 dependency injection hilt dagger](./curriculum/week-13-dependency-injection-hilt-dagger/00-overview.md)
- [week 14 persistence room datastore filesystem](./curriculum/week-14-persistence-room-datastore-filesystem/00-overview.md)
- [week 15 networking retrofit okhttp ktor grpc](./curriculum/week-15-networking-retrofit-okhttp-ktor-grpc/00-overview.md)
- [week 16 background work workmanager foreground services](./curriculum/week-16-background-work-workmanager-foreground-services/00-overview.md)
- [week 17 testing across every layer](./curriculum/week-17-testing-across-every-layer/00-overview.md)
- [week 18 performance macrobenchmark baseline profiles r8](./curriculum/week-18-performance-macrobenchmark-baseline-profiles-r8/00-overview.md)
- [week 19 kotlin multiplatform wear os intro](./curriculum/week-19-kotlin-multiplatform-wear-os-intro/00-overview.md)
- [week 20 multi form factor foldables wear tv automotive](./curriculum/week-20-multi-form-factor-foldables-wear-tv-automotive/00-overview.md)
- [week 21 cicd github actions fastlane play console](./curriculum/week-21-cicd-github-actions-fastlane-play-console/00-overview.md)
- [week 22 security keystore encryptedsharedprefs pinning play integrity](./curriculum/week-22-security-keystore-encryptedsharedprefs-pinning-play-integrity/00-overview.md)
- [week 23 capstone build field force companion](./curriculum/week-23-capstone-build-field-force-companion/00-overview.md)
- [week 24 capstone polish chaos drill play submission interview](./curriculum/week-24-capstone-polish-chaos-drill-play-submission-interview/00-overview.md)
