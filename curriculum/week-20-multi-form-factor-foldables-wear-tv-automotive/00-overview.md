...
| [resources.md](./01-resources.md) | The adaptive-layout guides, the foldable codelab, the Wear OS Compose docs, the Tiles and Complications guides, the TV and Automotive docs, and the canonical talks |
| [lecture-notes/01-adaptive-layouts-window-size-classes-foldables.md](./02-lecture-notes/01-adaptive-layouts-window-size-classes-foldables.md) | Window size classes, the `material3-adaptive` scaffolds, fold state with `WindowInfoTracker`, postures, and one adaptive layout that reflows across phone, tablet, and foldable |
| [lecture-notes/02-wear-os-deep-tiles-complications-tv-automotive.md](./02-lecture-notes/02-wear-os-deep-tiles-complications-tv-automotive.md) | Wear OS deep — the design inversion, `TransformingLazyColumn`, navigation, rotary, tiles, complications, ongoing activities — then TV and Automotive as overview and the "what not to build" judgment |
| [exercises/README.md](./03-exercises/00-overview.md) | Index of the three exercises |
| [exercises/exercise-01-window-size-class-adaptive-layout.md](./03-exercises/exercise-01-window-size-class-adaptive-layout.md) | Drive a layout from `WindowSizeClass`, reflow it across the resizable emulator, and observe a live fold with `WindowInfoTracker` |
| [exercises/exercise-02-wear-scaling-list-navigation.kt](./03-exercises/exercise-02-wear-scaling-list-navigation.kt) | Build a Wear screen with `TransformingLazyColumn`, `SwipeDismissableNavHost`, and rotary scroll; respect the round-screen constraints |
| [exercises/exercise-03-wear-tile-protolayout.kt](./03-exercises/exercise-03-wear-tile-protolayout.kt) | Author a Wear tile with `TileService` + ProtoLayout, version its resources, and set a freshness interval |
| [challenges/README.md](./04-challenges/00-overview.md) | Index of the challenge |
| [challenges/challenge-01-one-codebase-three-form-factors.md](./04-challenges/challenge-01-one-codebase-three-form-factors.md) | Take one feature and ship it correctly on phone, unfolded foldable, and Wear — one shared domain layer, three form-factor-appropriate UIs — and document each design decision |
| [quiz.md](./05-quiz.md) | 13 questions on window size classes, fold state, Wear components, tiles, complications, ongoing activities, and the TV/Automotive boundary |
| [homework.md](./06-homework.md) | Six practice problems for the week |
| [mini-project/README.md](./07-mini-project/00-overview.md) | Full spec for the Wear OS weather companion: an adaptive tile, a complication, and ongoing-activity rain alerts |
