...
- **A Play Console account** with the app record (the USD 25 one-time fee). The documented no-fee fallback is an **F-Droid** submission, which the syllabus accepts for learners who choose not to pay — the chaos drills and interviews are identical either way.
