...
| [resources.md](./resources.md) | The custom-layout and modifier docs, the gesture and animation guides, the accessibility docs, the WCAG contrast spec, and the canonical talks |
| [lecture-notes/01-custom-layout-modifiers-gestures.md](./lecture-notes/01-custom-layout-modifiers-gestures.md) | Custom `Layout` and the measure/place contract, the `Modifier` chain as an ordered pipeline (with the reorder gallery), and `pointerInput` gesture detection end to end |
| [lecture-notes/02-animation-semantics-accessibility.md](./lecture-notes/02-animation-semantics-accessibility.md) | The animation API family and spec/timing, Compose semantics and TalkBack, custom accessibility actions, and WCAG contrast + large-text compliance |
| [exercises/README.md](./exercises/README.md) | Index of the three exercises |
| [exercises/exercise-01-modifier-order-and-custom-layout.md](./exercises/exercise-01-modifier-order-and-custom-layout.md) | Predict-then-confirm a modifier-reorder gallery, then write a custom flow `Layout` from the measure/place contract |
| [exercises/exercise-02-drag-with-spring-back.kt](./exercises/exercise-02-drag-with-spring-back.kt) | Detect a horizontal drag with `pointerInput`, feed it into an `Animatable`, and spring back on release |
| [exercises/exercise-03-semantics-and-contrast.kt](./exercises/exercise-03-semantics-and-contrast.kt) | Add semantics + a custom action to a gesture component, and write a WCAG contrast-ratio check that fails a bad color pair |
| [challenges/README.md](./challenges/README.md) | Index of the challenge |
| [challenges/challenge-01-inaccessible-then-fixed.md](./challenges/challenge-01-inaccessible-then-fixed.md) | Take a gesture-only component that's invisible to TalkBack and fails contrast, audit it, fix it to full accessibility + AA contrast, and document the before/after with TalkBack and a contrast report |
| [quiz.md](./quiz.md) | 13 questions on custom layout, modifier ordering, gestures, the animation family, semantics, and WCAG contrast |
| [homework.md](./homework.md) | Six practice problems for the week |
| [mini-project/README.md](./mini-project/README.md) | Full spec for the swipe-to-dismiss card stack: elastic drag, spring-back, TalkBack custom actions, WCAG contrast audit |
