...
3. Signed AAB uploaded to a Play Console closed track. (F-Droid fallback acceptable for students who choose not to pay the Play developer fee.)
...
Every Crunch Droid student delivers the following before track completion:
...
3. **`portfolio.md`** — three polished projects suitable for a recruiter. One must be the capstone. The other two must be original, public, GPL-3.0 (or a permissive license of the student's choice), and accompanied by a one-page engineering narrative.
